...
// //   List<TContact> contactList = await DatabaseHelper().getContactList();
// //   if (contactList.isEmpty) {
// //     Fluttertoast.showToast(msg: "No contact exists. Please add a number.");
// //   } else {
...
// //       }).catchError((error) {
// //         Fluttertoast.showToast(msg: "Failed to send message to ${contact.name}");
// //       });
// //     }
// //   }
// // }
...
// //       isForegroundMode: true,
// //       autoStart: true,
// //       notificationChannelId: "script_academy_channel",
// //       initialNotificationTitle: "Women Safety App Service",
// //       initialNotificationContent: "Initializing...",
// //       foregroundServiceNotificationId: 888,
// //     ),
// //   );
...
// //
// //   // Update current location whenever available
// //   BackgroundLocation.getLocationUpdates((location) {
...
// //     if (await service.isForegroundService()) {
// //       ShakeDetector.autoStart(
// //         shakeThresholdGravity: 2.7, // Lower gravity for better shake sensitivity
...
// //             String messageBody =
// //                 "Emergency! My location is: https://www.google.com/maps/search/?api=1&query=${currentLocation!.latitude}%2C${currentLocation!.longitude}";
...
// //             : "Shake feature enabled. Location: ${currentLocation!.latitude}",
// //         NotificationDetails(
// //           android: AndroidNotificationDetails(
// //             "script_academy_channel",
// //             "Foreground Service",
